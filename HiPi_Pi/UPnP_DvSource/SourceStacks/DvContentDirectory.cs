...
namespace UPnP_DvSource.SourceStacks
{
    /// <summary>
    ...
    public class DvContentDirectory : IUPnPService
    {
        ...
        public event OnStateVariableModifiedHandler OnStateVariableModified_A_ARG_TYPE_BrowseLetter;
        ...
        public System.String A_ARG_TYPE_BrowseLetter
        {
            ...
            set
            {
               _S.SetStateVariable("A_ARG_TYPE_BrowseLetter", value);
            }
        }
        ...
        public UPnPModeratedStateVariable.IAccumulator Accumulator_A_ARG_TYPE_BrowseLetter
        {
            get
            {
                 return(((UPnPModeratedStateVariable)_S.GetUPnPService().GetStateVariableObject("A_ARG_TYPE_BrowseLetter")).Accumulator);
            }
            set
            {
                 ((UPnPModeratedStateVariable)_S.GetUPnPService().GetStateVariableObject("A_ARG_TYPE_BrowseLetter")).Accumulator = value;
            }
        }
        public double ModerationDuration_A_ARG_TYPE_BrowseLetter
        {
            get
            {
                 return(((UPnPModeratedStateVariable)_S.GetUPnPService().GetStateVariableObject("A_ARG_TYPE_BrowseLetter")).ModerationPeriod);
            }
            set
            {
                 ((UPnPModeratedStateVariable)_S.GetUPnPService().GetStateVariableObject("A_ARG_TYPE_BrowseLetter")).ModerationPeriod = value;
            }
        }
        ...
        public delegate void Delegate_X_BrowseByLetter(System.String ObjectID, DvContentDirectory.Enum_A_ARG_TYPE_BrowseFlag BrowseFlag, System.String Filter, System.String StartingLetter, System.UInt32 RequestedCount, System.String SortCriteria, out System.String Result, out System.UInt32 NumberReturned, out System.UInt32 TotalMatches, out System.UInt32 UpdateID, out System.UInt32 StartingIndex);
        ...
        public Delegate_X_BrowseByLetter External_X_BrowseByLetter = null;
        ...
        public void RemoveStateVariable_A_ARG_TYPE_BrowseLetter()
        {
            _S.GetUPnPService().RemoveStateVariable(_S.GetUPnPService().GetStateVariableObject("A_ARG_TYPE_BrowseLetter"));
        }
        ...
        public void RemoveAction_X_BrowseByLetter()
        {
             _S.GetUPnPService().RemoveMethod("X_BrowseByLetter");
        }
        ...
        private class _DvContentDirectory
        {
            ...
            {
                UPnPStateVariable[] RetVal = new UPnPStateVariable[15];
                ...
                RetVal[2] = new UPnPModeratedStateVariable("A_ARG_TYPE_BrowseLetter", typeof(System.String), false);
                RetVal[2].AddAssociation("X_BrowseByLetter", "StartingLetter");
                RetVal[3] = new UPnPModeratedStateVariable("A_ARG_TYPE_SortCriteria", typeof(System.String), false);
                RetVal[3].AddAssociation("Browse", "SortCriteria");
                RetVal[3].AddAssociation("Search", "SortCriteria");
                RetVal[3].AddAssociation("X_BrowseByLetter", "SortCriteria");
                RetVal[4] = new UPnPModeratedStateVariable("A_ARG_TYPE_Result", typeof(System.String), false);
                RetVal[4].AddAssociation("Browse", "Result");
                RetVal[4].AddAssociation("Search", "Result");
                RetVal[4].AddAssociation("X_BrowseByLetter", "Result");
                ...
                RetVal[5].AddAssociation("X_BrowseByLetter", "Filter");
                RetVal[6] = new UPnPModeratedStateVariable("A_ARG_TYPE_UpdateID", typeof(System.UInt32), false);
                RetVal[6].AddAssociation("Browse", "UpdateID");
                RetVal[6].AddAssociation("Search", "UpdateID");
                RetVal[6].AddAssociation("X_BrowseByLetter", "UpdateID");
                ...
                RetVal[7].AddAssociation("X_BrowseByLetter", "BrowseFlag");
                RetVal[8] = new UPnPModeratedStateVariable("TransferIDs", typeof(System.String), true);
                RetVal[9] = new UPnPModeratedStateVariable("SearchCapabilities", typeof(System.String), false);
                RetVal[9].AddAssociation("GetSearchCapabilities", "SearchCaps");
                RetVal[10] = new UPnPModeratedStateVariable("ContainerUpdateIDs", typeof(System.String), true);
                RetVal[11] = new UPnPModeratedStateVariable("A_ARG_TYPE_ObjectID", typeof(System.String), false);
                RetVal[11].AddAssociation("Browse", "ObjectID");
                RetVal[11].AddAssociation("Search", "ContainerID");
                RetVal[11].AddAssociation("X_BrowseByLetter", "ObjectID");
                RetVal[12] = new UPnPModeratedStateVariable("SystemUpdateID", typeof(System.UInt32), true);
                RetVal[12].AddAssociation("GetSystemUpdateID", "Id");
                RetVal[13] = new UPnPModeratedStateVariable("A_ARG_TYPE_Index", typeof(System.UInt32), false);
                RetVal[13].AddAssociation("Browse", "StartingIndex");
                RetVal[13].AddAssociation("Search", "StartingIndex");
                RetVal[13].AddAssociation("X_BrowseByLetter", "StartingIndex");
                RetVal[14] = new UPnPModeratedStateVariable("A_ARG_TYPE_Count", typeof(System.UInt32), false);
                RetVal[14].AddAssociation("Browse", "RequestedCount");
                RetVal[14].AddAssociation("Browse", "NumberReturned");
                RetVal[14].AddAssociation("Browse", "TotalMatches");
                RetVal[14].AddAssociation("Search", "RequestedCount");
                RetVal[14].AddAssociation("Search", "NumberReturned");
                RetVal[14].AddAssociation("Search", "TotalMatches");
                RetVal[14].AddAssociation("X_BrowseByLetter", "RequestedCount");
                RetVal[14].AddAssociation("X_BrowseByLetter", "NumberReturned");
                RetVal[14].AddAssociation("X_BrowseByLetter", "TotalMatches");
            ...
            public void X_BrowseByLetter(System.String ObjectID, System.String BrowseFlag, System.String Filter, System.String StartingLetter, System.UInt32 RequestedCount, System.String SortCriteria, out System.String Result, out System.UInt32 NumberReturned, out System.UInt32 TotalMatches, out System.UInt32 UpdateID, out System.UInt32 StartingIndex)
            {
                Enum_A_ARG_TYPE_BrowseFlag e_BrowseFlag;
                switch(BrowseFlag)
                {
                ...
                if (Outer.External_X_BrowseByLetter != null)
                {
                    Outer.External_X_BrowseByLetter(ObjectID, e_BrowseFlag, Filter, StartingLetter, RequestedCount, SortCriteria, out Result, out NumberReturned, out TotalMatches, out UpdateID, out StartingIndex);
                }
                else
                {
                    Sink_X_BrowseByLetter(ObjectID, e_BrowseFlag, Filter, StartingLetter, RequestedCount, SortCriteria, out Result, out NumberReturned, out TotalMatches, out UpdateID, out StartingIndex);
                }
            }
            ...
            public Delegate_X_BrowseByLetter Sink_X_BrowseByLetter;
        }
        public DvContentDirectory()
        {
            ...
            _S.GetUPnPService().GetStateVariableObject("A_ARG_TYPE_BrowseLetter").OnModified += new UPnPStateVariable.ModifiedHandler(OnModifiedSink_A_ARG_TYPE_BrowseLetter);
            ...
            _S.Sink_X_BrowseByLetter = new Delegate_X_BrowseByLetter(X_BrowseByLetter);
        }
        ...
        private void OnModifiedSink_A_ARG_TYPE_BrowseLetter(UPnPStateVariable sender, object NewValue)
        {
            if (OnStateVariableModified_A_ARG_TYPE_BrowseLetter != null) OnStateVariableModified_A_ARG_TYPE_BrowseLetter(this);
        }
        ...
        /// <summary>
        /// Action: X_BrowseByLetter
        /// </summary>
        /// <param name="ObjectID">Associated State Variable: A_ARG_TYPE_ObjectID</param>
        /// <param name="BrowseFlag">Associated State Variable: A_ARG_TYPE_BrowseFlag</param>
        /// <param name="Filter">Associated State Variable: A_ARG_TYPE_Filter</param>
        /// <param name="StartingLetter">Associated State Variable: A_ARG_TYPE_BrowseLetter</param>
        /// <param name="RequestedCount">Associated State Variable: A_ARG_TYPE_Count</param>
        /// <param name="SortCriteria">Associated State Variable: A_ARG_TYPE_SortCriteria</param>
        /// <param name="Result">Associated State Variable: A_ARG_TYPE_Result</param>
        /// <param name="NumberReturned">Associated State Variable: A_ARG_TYPE_Count</param>
